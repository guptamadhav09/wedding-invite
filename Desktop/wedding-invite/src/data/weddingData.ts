...
export const weddingEvents: WeddingEvent[] = [
  {
    ...
    description:
      "An enchanting afternoon and evening of intricate henna artistry, live music, delicious bites, and cheerful celebrations.",
    expandedDetails: [
      "Professional henna artists for all guests",
      "Live music and celebratory folk beats",
      "Gourmet chaat counters and refreshing cocktail bar",
  ...
  },
  {
    ...
    venue: "Venue to be finalised",
    venueStatus: "tba",
    dress: "Glamorous Evening Wear / Tuxedos & Modern Lehengas",
    description:
      "A night under shimmering lights with craft cocktails, music, dancing, and unforgettable toasts with Mahek & Prateek.",
    expandedDetails: [
      "Signature cocktails and curated premium bar",
      "High-energy DJ set & dance floor until late",
      "Hors d'oeuvres and global cuisine dinner spread",
      "Venue details will be shared once finalised"
    ],
    image: "/assets/sangeet-event-BmxHAjex.webp",
  },
  {
    key: "wedding",
    name: "Wedding Ceremony",
    date: "Friday, 12th December 2025",
    time: "6:00 PM onwards (Baraat at 6:30 PM)",
    ...
    description:
      "The sacred vows where Mahek & Prateek unite for a lifetime of love and companionship. Surrounded by family, blessings, and sacred rituals.",
    expandedDetails: [
      "Grand Baraat procession with dhol drummers at 6:30 PM",
      "Varmala and sacred Pheras at sunset",
...
export const timelineData: TimelineItem[] = [
  {
    ...
    side: "below",
    festive: true,
    annotation: { lines: ["Venue to be announced", "Vibrant colors"] },
  },
  {
    day: "Thu",
    date: "11",
    ...
    side: "above",
    festive: true,
    annotation: { lines: ["Venue to be announced", "Evening glam"] },
  },
  {
    day: "Fri",
    date: "12",
    ...
    side: "below",
    festive: true,
    annotation: { lines: ["Evara, Vasundhara", "Royal Traditional"] },
  },
];
